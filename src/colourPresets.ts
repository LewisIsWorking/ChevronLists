...
export const COLOUR_PRESETS: ColourPreset[] = [
    {
        id:          'default',
        label:       '$(symbol-color) Default',
        description: 'Amber header, muted grey prefix, blue numbers',
        tokens: {
